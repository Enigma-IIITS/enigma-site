    ...
    return (
        <section >
            <div className="container px-6 py-10 mx-auto my-10 bg-zinc-950  sm:py-32">
                <h1 className="text-2xl font-bold text-center capitalize   tracking-tight text-cyan-500 sm:text-5xl ">Meet our Leads</h1>
                ...
                <div className=" flex justify-around items-center flex-wrap mt-10">
                    <PersonCard imgSrc={'https://github.com/shadcn.png'} name={'Person'} role={'lead'} />
                    <PersonCard imgSrc={'https://github.com/shadcn.png'} name={'Person'} role={'Co-lead'} />
                </div>
