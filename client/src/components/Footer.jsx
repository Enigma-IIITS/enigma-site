...
const Footer = () => {
    return (
        <footer className="bg-white dark:bg-gray-950  md:text-left text-center">
            <div className="container p-6 mx-auto">
                <div className="lg:flex">
                    <div className="w-full -mx-6 lg:w-2/5">
                        <div className="px-6 md:block flex flex-col w-screen justify-center items-center">
                            <a href="#">
                                <Image width={50} height={50} src='https://github.com/Enigma-IIITS/enigma-site/assets/116871732/c72bc255-b90b-45f6-b980-b7b451d6465c' alt="" />
                            </a>
